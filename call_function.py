...
from functions.run_bash_command import run_bash_command, schema_run_bash_command
...
def describe_call(name, args):
    ...
    match name:
        ...
        case "get_files_info":
            ...
            abs_path = os.path.abspath(os.path.join(config.WORKING_DIRECTORY, directory))
